export const varidianTokenContractAddress: `0x${string}` = '0x646e5c61ec28f03b800447db10a1d0bbfe655b30';

export const varidianTokenContractAbi = [
...
export const varidianTokenSolidityCode = `
